...
App::App()
    : wnd(1500, 1000), gfx(wnd.GetHwnd()), leftWall(gfx, 500.f, 200.f, -500.f, -5.f, 200.f, DirectX::XM_PIDIV2),
      rightWall(gfx, 500.f, 200.f, 500.f, -5.f, 200.f, DirectX::XM_PIDIV2), frontWall(gfx, 500.f, 200.f, 0.f, -5.f, 700.f, 0.f),
      floor(gfx, -2500.f, -205.f, -2500.f)
{
    ...
    // shapes.push_back(std::make_unique<SheetTextured>(
    //     gfx, false, false, true, false, 0.f, 50.f, 680.f, 0, 0.f, 0.f, 100.f, 100.f, L"images//pashok.png"));
    // shapes.push_back(std::make_unique<SheetTextured>(
    //     gfx, false, false, true, false, -250.f, 50.f, 680.f, 0, 0.f, 0.f, 100.f, 100.f, L"images//kim.jpeg"));
    // shapes.push_back(std::make_unique<SheetTextured>(
    //     gfx, false, false, true, false, 250.f, 50.f, 680.f, 0, 0.f, 0.f, 100.f, 100.f, L"images//putin.jpg"));
    ...
    bool ModeRotation  = true;
    bool Moving        = true;

    for (int i = 0; i < boxesCount; i++)
    {
        shapes.push_back(std::make_unique<Box>(gfx, RandomCoord, WorldRotation, ModeRotation, Moving));
    }
}
